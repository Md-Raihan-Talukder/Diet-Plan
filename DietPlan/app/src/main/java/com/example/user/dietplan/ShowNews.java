...
public class ShowNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL.bmi                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {

                        //Toast.makeText(ShowNews.this, response, Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (jsonArray.length() == 0) {
                                Toast.makeText(ShowNews.this, "No Data Recorded", Toast.LENGTH_SHORT).show();
                            } else {
                        ...
                        newsAdapter = new NewsAdapter(ShowNews.this, newsUnitList);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ShowNews.this, "vulval "+error.toString(), Toast.LENGTH_SHORT).show();

            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(ShowNews.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ShowNews.this, Details.class);
